...
exports.configureAuthMethods = exports.UserAuthKeyAuthentication = exports.RestApiKeyAuthentication = void 0;
...
var UserAuthKeyAuthentication = (function () {
    function UserAuthKeyAuthentication(tokenProvider) {
        this.tokenProvider = tokenProvider;
    }
    UserAuthKeyAuthentication.prototype.getName = function () {
        return "user_auth_key";
    };
    UserAuthKeyAuthentication.prototype.applySecurityAuthentication = function (context) {
        return __awaiter(this, void 0, void 0, function () {
            var _a, _b, _c, _d;
            return __generator(this, function (_e) {
                switch (_e.label) {
    ...
    return UserAuthKeyAuthentication;
}());
exports.UserAuthKeyAuthentication = UserAuthKeyAuthentication;
function configureAuthMethods(config) {
    ...
    if (config["user_auth_key"]) {
        authMethods["user_auth_key"] = new UserAuthKeyAuthentication(config["user_auth_key"]["tokenProvider"]);
    }
    return authMethods;
}
